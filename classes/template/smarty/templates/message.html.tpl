...
{if !isset($hidecontrols)}
 <div class="btn-group pull-right">
  {if ($message.mayCancel)}<a href="javascript:deletePost(cancel.php?boardid={$board.boardid|escape:url}&amp;messageid={$message.messageid|encodeMessageID|escape:url})" class="btn btn-danger btn-mini deletePost"><i class="icon-trash icon-white"></i> L&ouml;schen</a>{/if}

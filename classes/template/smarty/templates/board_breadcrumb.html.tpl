...
<li class="stylesheet"><a href="#white" onclick="setActiveStyleSheet('');return(false)">Blau-Wei&szlig;</a> | <a href="#cyan" onclick="setActiveStyleSheet('JuPi-Theme');return(false)">Schwarz-Cyan</a></li>

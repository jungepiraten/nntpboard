...
class MemCachedIMAPBoard extends CachedIMAPBoard {
	...
	public function __construct($boardid, $parentid, $name, $desc, $indexer, $readAuthManager, $writeAuthManager, $isModerated, $memcache, $host, $loginusername, $loginpassword, $folder, $writer) {

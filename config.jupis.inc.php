...
class JuPiConfig extends DefaultConfig {
	...
	private function addRegionStruktur($id, $parentid) {
		...
		$this->addRegionBoard(14, 13, "lv.be", "Berlin", "BE:Hauptseite", "be");
		$this->addRegionBoard(25, 13, "lv.nrw", "Nordrhein-Westfalen", "NRW:Hauptseite", "nrw");
		$this->addRegionBoard(110,25, "lv.nrw.do", "Dortmund", "NRW:Dortmund", "nrw-do");
		$this->addRegionBoard(26, 13, "lv.he", "Hessen", "HE:Hauptseite", "he");
		$this->addRegionBoard(28, 13, "lv.bw", "Baden-Württemberg", "BW:Hauptseite", "bw");
		$this->addRegionBoard(601,28, "crew.freiburg", "Freiburg", "BW:Freiburg", "crew-freiburg");
		$this->addRegionBoard(32, 13, "lv.nds", "Niedersachsen", "NDS:Hauptseite", "ni");
		$this->addRegionBoard(35, 13, "lv.by", "Bayern", "BY:Hauptseite", "by");
		$this->addRegionBoard(100,35, "lv.by.mfr", "Mittelfranken", "BY:Mittelfranken", "by-mfr");
		$this->addRegionBoard(101,35, "lv.by.muc", "München", "BY:Muenchen", "by-muc");
		$this->addRegionBoard(45, 13, "lv.bb", "Brandenburg", "BB:Hauptseite", "bb");
		$this->addRegionBoard(47, 13, "lv.hb", "Bremen", "HB:Hauptseite", "hb");
		$this->addRegionBoard(49, 13, "lv.hh", "Hamburg", "HH:Hauptseite", "hamburg");
		$this->addRegionBoard(51, 13, "lv.mv", "Mecklenburg-Vorpommern", "MV:Hauptseite", "mv");
		$this->addRegionBoard(53, 13, "lv.rlp", "Rheinland-Pfalz", "RLP:Hauptseite", "rlp");
		$this->addRegionBoard(55, 13, "lv.sl", "Saarland", "SL:Hauptseite", "sl");
		$this->addRegionBoard(57, 13, "lv.sn", "Sachsen", "SN:Hauptseite", "sn");
		$this->addRegionBoard(59, 13, "lv.lsa", "Sachsen Anhalt", "LSA:Hauptseite", "st");
		$this->addRegionBoard(61, 13, "lv.sh", "Schleswig-Holstein", "SH:Hauptseite", "sh");
		$this->addRegionBoard(63, 13, "lv.th", "Thüringen", "TH:Hauptseite", "th");
	}
